    ...
    <div className="flex flex-col h-screen bg-gray-50 dark:bg-transparent text-gray-900 dark:text-gray-100 font-sans justify-center items-center p-4">
      <div className="w-full max-w-sm mx-auto">
        <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">{isSigningUp ? "Create Account" : t.loginTitle}</h1>
            <p className="text-md text-gray-600 dark:text-gray-400 mt-1">{isSigningUp ? "Get started with your AI assistant" : t.loginSubtitle}</p>
        </div>
        <div className="bg-white/60 dark:bg-gray-800/40 backdrop-blur-md border border-gray-200/80 dark:border-white/10 rounded-xl p-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {isSigningUp ? "Sign Up" : t.loginButton}
              </button>
            </form>
